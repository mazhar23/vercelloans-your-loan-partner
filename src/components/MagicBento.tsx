...
import { Zap, ShieldCheck, BadgeDollarSign, Clock, CheckCircle2, Star, LucideIcon } from "lucide-react";
...
const cardData: BentoCardData[] = [
  {
    ...
    description: "Get pre-qualified instantly with a soft credit pull.",
    label: "Instant Pre-Qual",
    icon: Zap
  },
  {
    title: "Bank-Grade Security",
    description: "256-bit encryption. We never share your data.",
    label: "Safe & Secure",
    icon: ShieldCheck
  },
  {
    title: "Fixed Rates",
    description: "Predictable monthly payments from 5.99% APR.",
    label: "No Surprises",
    icon: BadgeDollarSign
  },
  {
    title: "Funded Fast",
    description: "Money in your bank as soon as the next business day.",
    label: "Quick Deposits",
    icon: Clock
  },
  {
    title: "No Prepayment Fees",
    description: "Pay off your loan early without penalties.",
    label: "Flexible Payoff",
    icon: CheckCircle2
  },
  {
    title: "Top-Rated Support",
    description: "Real humans, 7 days a week. Average wait under 2 minutes.",
            ...
            return (
              ...
              >
                <div className="magic-bento-card__header">
                  ...
                  <CardIcon className="h-5 w-5 text-muted-foreground opacity-60" />
                </div>

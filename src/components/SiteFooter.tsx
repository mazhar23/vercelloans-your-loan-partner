    ...
    <footer className="border-t border-border bg-secondary/40 mt-20">
      <div className="container mx-auto px-4 py-14 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-1">
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Fast, transparent personal loans for U.S. residents. Funds delivered straight to your
            bank account.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              <Link to="/loans" className="hover:text-foreground">
                Personal Loans
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4" /> 1-312-373-0471
            </li>
            <li className="flex items-center gap-2">
              <MapPin className="h-4 w-4" /> Downtown Chicago, Illinois., USA
            </li>
          </ul>
        </div>
      </div>
      <div className="border-t border-border">
        <div className="container mx-auto px-4 py-6 text-xs text-muted-foreground flex flex-col md:flex-row gap-3 justify-between">
          ...
          <p>
            Demo site for illustration only. Not an actual lender. APRs and terms shown are
            examples.
          </p>
        </div>
      </div>
